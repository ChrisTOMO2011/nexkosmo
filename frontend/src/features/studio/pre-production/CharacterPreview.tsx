...
export function CharacterPreview({
  ...
  return (
    <section className="character-preview" aria-label="Character cinematic preview">
      <div className={`preview-image preview-slide-${slide}`}>
        ...
        <div className="preview-controls">
          ...
          <button
            ...
            onClick={() => onPlaceholder("Fullscreen preview placeholder opened.")}
          >
        ...
        <div className="carousel-dots" aria-label={`Preview ${slide + 1} of 5`}>
          {[0, 1, 2, 3, 4].map((index) => (
            <button
              type="button"
              key={index}
